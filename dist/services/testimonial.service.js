...
class testiService {
    ...
    createTestimonials(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newTestimonials = yield testimonials_1.Testimonial.create(data);
    ...
    getTestimonial(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const testimonial = yield testimonials_1.Testimonial.findById({ _id: id });
                if (!testimonial) {
    ...
    updateTestimonial(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const testimonialz = yield testimonials_1.Testimonial.findByIdAndUpdate({ _id: id }, data, { new: true });
                if (!testimonialz) {
                    return "Honest Feedack not available :(";
                }
                return testimonialz;
    ...
    deleteTestimonial(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const testimonial = yield testimonials_1.Testimonial.findByIdAndDelete(id);
                if (!testimonial) {
                    return "Honest Feedack not available :(";
                }
            }
