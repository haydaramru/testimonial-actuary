...
class testiController {
    constructor() {
        ...
        this.addTestimonial = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { error, value } = testimonials_1.testiSchemaValidate.validate(data);
            if (error) {
                res.send(error.message);
            }
            else {
                // call the create post function in the service and pass the data from the request
                const testimonial = yield testimonial_service_1.testiServices.createTestimonials(value);
                res.status(201).send(testimonial);
            }
        });
        // get all testimonies
        this.getTestimonials = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const testimonials = yield testimonial_service_1.testiServices.getTestimonials();
        ...
        this.getATestimonial = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const testimonial = yield testimonial_service_1.testiServices.getTestimonial(id);
            res.send(testimonial);
        });
        // update testimonies
        this.updateTestimonial = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const id = req.params.id;
            const testimonial = yield testimonial_service_1.testiServices.updateTestimonial(id, req.body);
            res.send(testimonial);
        });
        // delete a testimonies
        this.deleteTestimonial = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const id = req.params.id;
            yield testimonial_service_1.testiServices.deleteTestimonial(id);
